...
CREATE TABLE `domainplan` (
  ...
  `off_plan` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(1, 'Awesome Software Features', 'As we add more technology to our lives to meet our business needs, the customer support software system has become increasingly essential. Itâ€™s now much more than just a ticketing system! Itâ€™s evolved into a vital supply of customer data and information.');
...
CREATE TABLE `taps` (
  `id` int(11) NOT NULL,
  `taps` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
